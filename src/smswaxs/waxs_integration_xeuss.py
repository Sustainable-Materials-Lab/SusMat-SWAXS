...
def cli():
    ...
    parser.add_argument(
        "--thickness", help="thickness in cm used for transmission correction (otherwise, transmitted intensity used)",type=float, default=float(0))
    ...
    parser.add_argument("--unit", help="Radial unit for integration, q or 2th",type=str,default="q")
    ...
    if args.noabs is False:
        def abscor (tth,intensity,trans):
            ...
            Xenocs Xeuss 2.0C user manual (2020)"""
    ...
    if args.raw2D == False:
        ...
        fig1 = axs['(a)'].imshow(data_2I,norm=LogNorm(vmin=I2min, vmax=I2max),cmap=plt.get_cmap('cividis'),aspect="auto")
