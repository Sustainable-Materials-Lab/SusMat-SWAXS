...
with open(args.sample[:-4]+".poni", 'w') as poni_temp:

    poni_temp.writelines(["poni_version: 2","\n",
                          "Detector: Eiger1M","\n",
                          "Detector_config: {}","\n",
                          "Distance: "+str(file.header['SampleDistance']),"\n",
                          "Poni1: "+str(float(file.header['PSize_2'])*float(file.header['Center_2'])),"\n",
                          "Poni2: "+str(float(file.header['PSize_1'])*float(file.header['Center_1'])),"\n",
                          "Rot1: 0","\n",
                          "Rot2: 0","\n",
                          "Rot3: 0","\n",
                          "Wavelength: "+file.header['WaveLength']
        ])

poni = pyFAI.load(args.sample[:-4]+".poni")
